...
class LaserProj : public IProjectile{

public:

    LaserProj(Vector2 position, double speed, Vector2 direction, bool foe, int damage) :
    ...
    const std::type_info& get_type() { return typeid(LaserProj); }
