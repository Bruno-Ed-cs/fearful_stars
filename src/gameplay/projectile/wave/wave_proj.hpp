...
class WaveProj : public IProjectile{

public:

    WaveProj(Vector2 position, double speed, Vector2 direction, bool foe, int damage) :
    ...
    const std::type_info& get_type() { return typeid(WaveProj); }
